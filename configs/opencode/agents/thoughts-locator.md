---
description: Discovers relevant documents in thoughts/ directory. Use this subagent for finding historical context and documentation that might be relevant to your current research task.
mode: subagent
model: inherit
temperature: 0.1
tools:
